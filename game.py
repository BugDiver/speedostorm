...
# button (message ,button_start_x ,button_start_y ,button_width ,butto_height ,normal_color ,hover_color)
...
def game_intro():
    ...
    while intro:
        ...
        largeText = pygame.font.Font('freesansbold.ttf', 115)
        TextSurf, TextRect = text_objects("špëędôśtørm".decode("UTF-8"), largeText ,black)
        TextRect.center = ((display_width / 2), (display_height / 2))
        gameDisplay.blit(TextSurf, TextRect)
